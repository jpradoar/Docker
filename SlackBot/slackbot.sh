#!/bin/bash
# Source of this script: https://blog.sleeplessbeastie.eu
...
# ./slackbot.sh -h https://hooks.slack.com/services/xxxxx/yyyy/zzzz -c asd1234 -u jprado -i floppy_disk -C ff3300 -T "[ALERT]" -m $(hostname) test ok" 
